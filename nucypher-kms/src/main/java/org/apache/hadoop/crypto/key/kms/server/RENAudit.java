 ...
 * types of events.
 * TODO push all meaningful functionality to common parent with KMSAudit
 */
public class RENAudit {

  private static class AuditEvent {
    private final AtomicLong accessCount = new AtomicLong(-1);
    private final String keyName;
    private final String user;
    private final REN.RENOp op;
    private final String extraMsg;
    private final long startTime = System.currentTimeMillis();

    private AuditEvent(String keyName, String user, REN.RENOp op, String msg) {
  ...
  private static Set<REN.RENOp> AGGREGATE_OPS_WHITELIST = Sets.newHashSet(
    REN.RENOp.TRANSFORM_EEK, REN.RENOp.DELETE_REK
  );
  ...
  public static final String REN_LOGGER_NAME = "kms-audit";

  private static Logger AUDIT_LOG = LoggerFactory.getLogger(REN_LOGGER_NAME);
  ...
  private void op(OpStatus opStatus, final REN.RENOp op, final String user,
  ...
  public void ok(UserGroupInformation user, REN.RENOp op, String key,
      String extraMsg) {
    op(OpStatus.OK, op, user.getShortUserName(), key, extraMsg);
  }

  public void ok(UserGroupInformation user, REN.RENOp op, String extraMsg) {
    op(OpStatus.OK, op, user.getShortUserName(), null, extraMsg);
  }

  public void unauthorized(UserGroupInformation user, REN.RENOp op, String key) {
  ...
  private static String createCacheKey(String user, String key, REN.RENOp op) {
    return user + "#" + key + "#" + op;
  }
