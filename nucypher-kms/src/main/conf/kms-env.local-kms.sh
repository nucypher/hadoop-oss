...
# Set local kms specific environment variables here.
#
...
#
export KMS_TEMP=${NUCYPHER_KMS_PREFIX}/temp

# The HTTP port used by KMS
#
export KMS_HTTP_PORT=16010
...
# Location of tomcat
#
export KMS_CATALINA_HOME=${NUCYPHER_KMS_PREFIX}/share/hadoop/kms/tomcat
