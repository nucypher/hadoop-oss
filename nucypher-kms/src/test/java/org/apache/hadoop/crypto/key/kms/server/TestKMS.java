...
public class TestKMS {
  ...
  protected Configuration createBaseKMSConf(File keyStoreDir) throws Exception {
    ...
    conf.set(KMSConfiguration.KEY_PROVIDER_URI,
        "jcekps://file@" + new Path(keyStoreDir.getAbsolutePath(), "kms.keystore").toUri());
    conf.set("hadoop.kms.authentication.type", "simple");
    conf.set("hadoop.security.crypto.cipher.suite", "BBS98/None/Padding");
    conf.set("hadoop.security.crypto.codec.classes.bbs98.none.padding", "org.apache.hadoop.crypto.BBS98CryptoCodec");
    conf.set("hadoop.kms.cache.enable", "false");
