...
public class TestKeyShell {
  ...
  /* The default JCEKS generators - for testing purposes */
  ...
  private void deleteKey(KeyShell ks, String keyName) throws Exception {
    ...
    final String[] delArgs =
        {"delete", keyName, "-f", "-generators", jceksProvider};
    rc = ks.run(delArgs);
    assertEquals(0, rc);
  ...
  private String listKeys(KeyShell ks, boolean wantMetadata) throws Exception {
    int rc;
    outContent.reset();
    final String[] listArgs = {"list", "-generators", jceksProvider };
    final String[] listArgsM = {"list", "-metadata", "-generators", jceksProvider };
  ...
  public void testKeySuccessfulKeyLifecycle() throws Exception {
    ...
    outContent.reset();
    final String[] args1 = {"create", keyName, "-generators", jceksProvider};
    rc = ks.run(args1);
    assertEquals(0, rc);
    assertTrue(outContent.toString().contains(keyName + " has been " +
    ...
    outContent.reset();
    final String[] args2 = {"roll", keyName, "-generators", jceksProvider};
    rc = ks.run(args2);
    assertEquals(0, rc);
  ...
  public void testKeySuccessfulCreationWithDescription() throws Exception {
    outContent.reset();
    final String[] args1 = {"create", "key1", "-generators", jceksProvider,
  ...
  public void testInvalidKeySize() throws Exception {
    final String[] args1 = {"create", "key1", "-size", "56", "-generators",
            jceksProvider};
  ...
  public void testInvalidCipher() throws Exception {
    final String[] args1 = {"create", "key1", "-cipher", "LJM", "-generators",
            jceksProvider};
  ...
  public void testInvalidProvider() throws Exception {
    final String[] args1 = {"create", "key1", "-cipher", "AES", "-generators",
  ...
  public void testAttributes() throws Exception {
    ...
    final String[] args1 = {"create", "keyattr1", "-generators", jceksProvider,
            "-attr", "foo=bar"};
    rc = ks.run(args1);
    assertEquals(0, rc);
    ...
    outContent.reset();
    final String[] args2 = {"create", "keyattr2", "-generators", jceksProvider,
            "-attr", "=bar"};
    rc = ks.run(args2);
    assertEquals(1, rc);
    ...
    outContent.reset();
    final String[] args3 = {"create", "keyattr3", "-generators", jceksProvider,
            "-attr", "foo = bar",
            "-attr", " glarch =baz  ",
            "-attr", "abc=def"};
    rc = ks.run(args3);
    ...
    outContent.reset();
    final String[] args4 = {"create", "keyattr4", "-generators", jceksProvider,
            "-attr", "foo=bar",
            "-attr", "foo=glarch"};
    rc = ks.run(args4);
    assertEquals(1, rc);
