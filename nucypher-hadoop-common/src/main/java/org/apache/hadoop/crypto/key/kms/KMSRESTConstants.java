...
public class KMSRESTConstants {
  ...
  public static final String KEY_PAIR_RESOURCE = "keypair";
  public static final String KEYS_RESOURCE = "keys";
  public static final String KEY_PAIRS_RESOURCE = "keypairs";
  ...
  public static final String KEY_VERSION_SRC_DST_RESOURCE = "keysrcdstversions";
  public static final String KEY_PAIR_VERSION_RESOURCE = "keypairversion";
  ...
  public static final String REK_SUB_RESOURCE = "_rek";
  ...
  public static final String REK_OP = "rek_op";
  public static final String REK_GENERATE = "generate";
  ...
  public static final String PUBLIC_MATERIAL_FIELD = "pkmaterial";
  public static final String SECRET_MATERIAL_FIELD = "skmaterial";
