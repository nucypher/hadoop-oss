...
public abstract class ReEncryptionKeyProviderFactory {
  public static final String KEY_PROVIDER_PATH =
      "hadoop.security.re.key.provider.path";

  public abstract ReEncryptionKeyProviderInterface createProvider(URI providerName,
                                             Configuration conf
                                             ) throws IOException;

  private static final ServiceLoader<ReEncryptionKeyProviderFactory> serviceLoader =
      ServiceLoader.load(ReEncryptionKeyProviderFactory.class,
          ReEncryptionKeyProviderFactory.class.getClassLoader());

  // Iterate through the serviceLoader to avoid lazy loading.
  // Lazy loading would require synchronization in concurrent use cases.
  static {
    Iterator<ReEncryptionKeyProviderFactory> iterServices = serviceLoader.iterator();
   ...
   */
  public static ReEncryptionKeyProviderInterface get(URI uri, Configuration conf)
      throws IOException {
    ReEncryptionKeyProviderInterface kp = null;
    for (ReEncryptionKeyProviderFactory factory : serviceLoader) {
